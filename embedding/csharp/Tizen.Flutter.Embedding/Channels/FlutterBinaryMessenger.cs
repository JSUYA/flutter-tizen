...
{
    /// <summary>
    /// A binary messenger bound to a specific Flutter engine.
    /// </summary>
    internal class FlutterBinaryMessenger : IBinaryMessenger
    {
        ...
        /// <summary>
        /// Creates a messenger for the provided Flutter desktop messenger handle.
        /// </summary>
        public FlutterBinaryMessenger(FlutterDesktopMessenger messenger)
        {
            _messenger = messenger ?? throw new ArgumentNullException(nameof(messenger));
            if (_messenger.IsInvalid)
            {
                throw new ArgumentException("messenger cannot be invalid", nameof(messenger));
            }
